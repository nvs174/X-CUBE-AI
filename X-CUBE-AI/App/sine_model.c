...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "0x8258fa89eb5c479a0abba3be7fb7a0d0"
...
#define AI_TOOLS_DATE_TIME   "2025-04-10T15:16:59+0300"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_200_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #11 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_200_output, AI_STATIC,
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 1), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &serving_default_keras_tensor_200_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_200_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    128, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_IN_NUM, &serving_default_keras_tensor_200_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_OUT_NUM, &gemm_2_output),
  &gemm_0_layer, 0xad481e17, NULL)
